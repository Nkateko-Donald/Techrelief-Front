          ...
          {!isVotingActive && isSessionEnded && (
            <div className="mt-6 pt-4 border-t border-gray-200">
              ...
              <p className="text-gray-500 text-sm mt-2 text-center">
                This nominee has been elected and will now become a community
                leader
              </p>
            </div>
          )}
      ...
      <div className="page-inner">
        ...
        >
          <div className="text-center">
            ...
            <h5 className="fw-light">Loading Votes...</h5>
          </div>
        </div>
      </div>
    );
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 mb-8">
            ...
            <div
              className=" rounded-xl border border-purple-200 p-6 mb-10"
              style={{
                background: "linear-gradient(135deg, #ff0000 0%, #764ba2 100%)",
              }}
            >
